...
\midrule
\endhead
Generalized linear & \texttt{stats}, \texttt{biglm}\tabularnewline
Mixed effects & \texttt{lme4}, \texttt{nlme}\tabularnewline
Econometric & \texttt{pglm}\tabularnewline
Bayesian & \texttt{brms}, \texttt{blme}, \texttt{MCMCglmm}, \texttt{rstan}\tabularnewline
Machine learning & \texttt{mlr}, \texttt{caret}\tabularnewline
\bottomrule
\end{longtable}
