...
where \(logit(\cdot)\) is the link function, which is equivelent to the
...
\textbf{Steps to accomplish the goal of extracting and graphing the }top
100** boys names in England and Wales for every year since 1996:**
