...
\textbf{GOAL: Popularity of your name}
...
\section{Creating variables within
groups}\label{creating-variables-within-groups}

\textbf{GOAL: Finding the most popular names}
...
\section{Aggregating variables within
groups}\label{aggregating-variables-within-groups}

\textbf{GOAL:Percent choosing one of the top 10 names}
...
\textbf{Goal: Counting chapters, lines, \& words}
...
\begin{Highlighting}[]
\CommentTok{# syntax}
\BuiltInTok{object}\NormalTok{[ start : end : by ]}

\CommentTok{# default}
\BuiltInTok{object}\NormalTok{[ }\DecValTok{0}\NormalTok{ : end : }\DecValTok{1}\NormalTok{ ]}
\end{Highlighting}
\end{Shaded}
...
structures}\label{iterating-over-data-structures}

\textbf{Goal: Working with nested structures}
...
\textbf{Goal: Import numpy \& calculate simple statistics}
