...
\tightlist
\item
  download and \textbf{install R}
\item
  download and \textbf{install RStudio}
\item
...
Before starting any of our Python workshops, it is necessary to complete 2 tasks. Please make sure both these tasks are completed \textbf{before} you attend your workshop, as, depending on your internet speed, they may take a long time. If you are unable to complete all of the tasks, please stop by the training room at least 20 minutes prior to the start of the workshop.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  download and \textbf{install Anaconda Python 3 distribution}
\item
  download and unzip \textbf{class materials}
\end{enumerate}
