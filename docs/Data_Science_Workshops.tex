...
take a long time. If you are unable to complete all of the tasks, please
stop by the training room at least 20 minutes prior to the start of the
workshop.
...
and press Enter. \textbf{When you install \texttt{tidyverse} for the
first time you will be asked a question} \textbf{about installing
packages from source - please answer by typing ``no'' in the console.} A
number of messages will then scroll by, and there will be a long minute
...
speed, they may take a long time. If you are unable to complete both
tasks, please stop by the training room at least 20 minutes prior to the
