...
\item
  ...
  \item
    ...
    bias).
  \item
    The model is linear in the parameters (i.e., the cofficients and
    error term).
  \item
  ...
  \item
    (Optional - only for inference). The error term is normally
    distributed.
  \end{enumerate}
\end{itemize}
...
\item
  ...
  worked (everwrk) using age (age\_p) and marital status (r\_maritl).
\end{enumerate}
