...
\item
  In the left hand window (called the ``console''), at the command prompt \texttt{\textgreater{}} type:

  \texttt{install.packages("tidyverse")}

  and press Enter. \textbf{When you install \texttt{tidyverse} for the first time you may be asked a question}
...
\item
  ...
  \textbf{If not, please stop by the training room at least 20 minutes before the start of your workshop.}
\item
