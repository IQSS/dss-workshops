...
\section{Jupyter notebook setup}\label{jupyter-notebook-setup}

There are two ways to set up your working environment for using Jupyter
Notebooks:
...
\item
  using \textbf{Jupyter Notebook} directly
\end{enumerate}

\href{https://jupyterlab.readthedocs.io/en/stable/}{JupyterLab} is a
web-based interface for Jupyter Notebooks that combines many features
typically found on integrated development environments (IDEs).
...
media and can be viewed in a browser. Opening a notebook directly does
not give you access to features typically found on IDEs.
...
\item
  ...
  \texttt{\textless{}name\_of\_image.png})
\item
  Click the blue colored \texttt{Upload} button to upload the files to
