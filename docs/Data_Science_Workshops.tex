...
You should have already installed the \texttt{tidyverse} and \texttt{rmarkdown} packages onto your computer before the workshop
--- see \href{./Rinstall.html}{R Installation}. Now let's load these packages into the search path of our R session.
...
Our final task is to re-arrange the data so that it is all in a single table instead of in two side-by-side tables. For many similar tasks the \texttt{pivot\_longer()} function in the \texttt{tidyr} package is useful, but in this case we will be better off using a combination of \texttt{select()} and \texttt{bind\_rows()}. Here's the logic behind this step:
...
NOTE: some Excel files include extra blank columns between the first and second set of \texttt{Name} and \texttt{Count} columns, resulting in different numeric suffixes for the second set of columns. You will need to use a regular expression
(regex) to match each of these different column names. HINT: see the \texttt{?matches} function.
...
\NormalTok{cleanupNamesData \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(file)\{}
  ...
  \CommentTok{\# subsets data to include only those columns that include the term \textasciigrave{}Name\textasciigrave{} and \textasciigrave{}Count\textasciigrave{} and apply listwise deletion}
...
Now let's view our list of data frames again --- we can see that year information has been added to each element as a name just after the \texttt{\$} extractor:
...
\includegraphics{R/RDataWrangling/figures/unnamed-chunk-278-1.pdf}
...
## 0                           None                    0  ...  image: 38.8 x 48.5 cm (15 ...  [{'id': 'https://iiif.harv...
## 1  © Jasper Johns and ULAE/Li...                    0  ...  sight: 127 x 87.6 x 10.2 c...  [{'id': 'https://iiif.harv...
## 2  © Estate of Alfred Stiegli...                    0  ...  27.6 x 20 cm (10 7/8 x 7 7...  [{'id': 'https://iiif.harv...
## 3                           None                    0  ...  257.98 g\r\n13.2 × 9.7 cm ...  [{'id': 'https://iiif.harv...
## 4  © Estate of Alfred Stiegli...                    0  ...  17.8 x 14.6 cm (7 x 5 3/4 ...  [{'id': 'https://iiif.harv...
## 5  © Estate of Alfred Stiegli...                    0  ...  12 x 23.3 cm (4 3/4 x 9 3/...  [{'id': 'https://iiif.harv...
## 6                           None                    1  ...  4 x 21.7 x 3.3 cm (1 9/16 ...  [{'id': 'https://iiif.harv...
## 7                           None                    0  ...  H. 64 x W. 19 x D. 15.5 cm...  [{'id': 'https://iiif.harv...
## 8                           None                    0  ...  2003.193.1: H. 35 x W. 27....  [{'id': 'https://iiif.harv...
## 9                           None                    0  ...  24.2 x 18.7 cm (9 1/2 x 7 ...  [{'id': 'https://iiif.harv...
## 
...
## 1   © Jasper Johns and ULAE/Li...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 2   © Estate of Alfred Stiegli...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 3                            None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 4   © Estate of Alfred Stiegli...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 5   © Estate of Alfred Stiegli...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 6                            None                    1  ...  [{'id': 'https://iiif.harv...                            NaN
...
## 13                           None                    1  ...  [{'id': 'https://iiif.harv...  {'technical': [{'text': '2...
## 14                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 15               © Richard Tuttle                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 16  © Estate of Alfred Stiegli...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
...
## 28  © Artists Rights Society (...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
...
## 34                    © Roni Horn                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 35                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 36                           None                    1  ...  [{'id': 'https://iiif.harv...  {'technical': [{'text': 'X...
## 37                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 38                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 39                           None                    1  ...  [{'id': 'https://iiif.harv...  {'technical': [{'text': 'X...
## 40  © Julian Faulhaber / Artis...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 41                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 42  Art © Nancy Graves Foundat...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
...
## 47  © Jenny Holzer / Artists R...                    0  ...  [{'id': 'https://iiif.harv...                            NaN
