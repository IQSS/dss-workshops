...
For these workshops we will use \href{https://rstudio.com/}{RStudio}; it is a good
...
at the command prompt (the bottom left panel) and press Enter.
...
If not please stop by the training room at least 20 minutes early.
...
at the command prompt (the bottom left panel), press Enter, and then wait for the
stream of messages to stop.
...
\subsubsection{Text editors \& Integrated Development Environments (IDEs)}\label{text-editors-integrated-development-environments-ides}}
