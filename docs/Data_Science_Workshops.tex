...
\section{Exercise: Reading text from a file \&
splitting}\label{exercise-reading-text-from-a-file-splitting}
...
\subsubsection{Sorting \& other in-place
...
\section{Exercise: Iterating \& counting
things}\label{exercise-iterating-counting-things}
