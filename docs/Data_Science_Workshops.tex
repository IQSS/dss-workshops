...
marginal means (average response values at particulat levels of the
predictors) on the response scale (i.e., the probability scale). We can
use the \texttt{effects} package to compute these quantities of interest
for us.
...
scrape a website. The scraping approach has to be tailored to each
individual site. Here are some commonly used approaches:
