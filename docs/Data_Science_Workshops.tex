...
\textbf{Your professionalism is greatly appreciated. Out of respect to your fellow workshop attendees and instructors, please show up to your workshop on time, having pre-installed all necessary software and materials.}
...
\textbf{If you have still not successfully installed \texttt{tidyverse} after troubleshooting, please stop by the training room 20 minutes before the start of your workshop so we can help you.}
...
\item
  ...
  \textbf{If you see error or warning messages, the installation was not successful.}
\end{enumerate}
