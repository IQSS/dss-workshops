...
the results of an analysis, R stores results in an \texttt{object}, so that an
...
When R is running, variables, data, functions, results, etc., are \textbf{stored} in
the memory of the computer in the form of \texttt{objects}, which have a name.
The user can \textbf{perform actions} on these objects with \texttt{operators} (arithmetic, logical,
