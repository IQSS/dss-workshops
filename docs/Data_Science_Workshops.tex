...
\NormalTok{read_baby_names <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(file, sheet_name) \{}
...
\KeywordTok{read_baby_names}\NormalTok{(boy_file_names[}\DecValTok{1}\NormalTok{], }\DataTypeTok{sheet_name =} \StringTok{"Table 1"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{glimpse}\NormalTok{()}


\NormalTok{  ## 3. Use the `map` function to read data from all the Excel files,}
\NormalTok{  ##    using the function you wrote in step 1.}

\NormalTok{boysNames <-}\StringTok{ }\KeywordTok{map}\NormalTok{(boy_file_names, read_baby_names, }\DataTypeTok{sheet_name =} \StringTok{"Table 1"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{## 3.  Finally, repeat the previous exercise, this time working with the data in one big table.}
