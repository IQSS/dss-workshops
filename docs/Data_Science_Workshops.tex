...
\item
  In the left hand window (called the \texttt{console}), at the command prompt \texttt{\textgreater{}} type the following and press enter:
...
\item
  ...
  \textbf{If not, please stop by the training room 20 minutes before the start of your workshop.}
\item
...
\item
  ...
  If successful, you should see a command prompt \texttt{\textgreater{}} and no messages in the console.
  \textbf{If not, please stop by the training room 20 minutes before the start of your workshop.}
\end{enumerate}
