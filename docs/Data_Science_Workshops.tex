...
One important part of the pre-estimation stage, is gaining an
understanding of the data we wish to model by creating plots and
summaries. Let's do this now.
...
\item
  Generating predicted outcomes from the model for interesting
