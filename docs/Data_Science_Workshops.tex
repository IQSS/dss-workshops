...
\NormalTok{baby_names <-}
\StringTok{  }\NormalTok{baby_names }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Rank_levels =} \KeywordTok{case_when}\NormalTok{(}
...
protocol domain path parameters https www.harvardartmuseums.org browse
load\_amount=10\&offset=0
