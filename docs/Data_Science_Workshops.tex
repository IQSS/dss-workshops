...
We can use \textbf{methods} (functions designed to work with specific classes of object) to extract various quantities from a fitted model object (sometimes referred to as \textbf{extractor functions}). A list of all the available methods for a given class of object can be shown by using the \texttt{methods()} function with the \texttt{class} argument set to the class of the model object:
...
There are 137 \texttt{summary()} methods and counting! Here's a schematic that shows the process of method dispatch in action:
...
Each \texttt{geom\_} function has a default statistic that it is paired with and, likewise, each \texttt{stat\_} function has a default geometic object that it is paired with. For example, the default statistic for \texttt{geom\_histogram()} is \texttt{stat\_bin()}, while the default geometric object for \texttt{stat\_bin()} is \texttt{geom\_bar()}. These defaults can be changed.

Arguments to \texttt{stat\_} functions can be passed through \texttt{geom\_} functions and vice versa. This can be slightly annoying, because in order to specify some arguments you have to first determine which statistic the geometric object uses, then determine the arguments to that statistic.

Let's look at the arguments for \texttt{geom\_histogram()}:
...
Notice that the third argument is \texttt{stat\ =\ "bin"}, which calls the \texttt{stat\_bin()} function. This is how the histogram geom is, by default, paired with the bin statistic. The fifth argument is \texttt{...}, which allows us to pass arguments to \texttt{stat\_bin()} through our call to \texttt{geom\_histogram()}. Now let's look at the arguments to \texttt{stat\_bin()}:
...
We can see that there is a \texttt{binwidth} argument to \texttt{stat\_bin()} that is not present for \texttt{geom\_histogram()}. But, we can still use this \texttt{binwidth} argument in \texttt{geom\_histogram()} --- it will automatically be passed to its paired statistic function. For example, here is the default histogram of \texttt{Home\_Value}:
...
We can change the binning scheme by passing the \texttt{binwidth} argument through \texttt{geom\_histogram()} to the \texttt{stat\_bin()} function:
...
Here is a list of geometric objects and their default statistics \url{https://ggplot2.tidyverse.org/reference/}
...
\includegraphics{R/Rgraphics/figures/unnamed-chunk-223-1.pdf}
...
\includegraphics{R/Rgraphics/figures/unnamed-chunk-224-1.pdf}
...
\includegraphics{R/Rgraphics/figures/unnamed-chunk-225-1.pdf}
...
\includegraphics{R/RDataWrangling/figures/unnamed-chunk-273-1.pdf}
...
## 0                           None                    1  ...  [{'id': 'https://iiif.harv...                            NaN
## 1  © Jasper Johns and ULAE/Li...                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 2                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 3                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 4                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 5                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 6                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 7                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 8                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 9                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 
...
## 8                            None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 9                            None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 10                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 11                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 12                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 13                           None                    1  ...  [{'id': 'https://iiif.harv...                            NaN
## 14                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 15                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 16                   © Mimi Smith                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 17                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 18  © Estate of Pablo Picasso ...                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 19                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 20                           None                    1  ...  [{'id': 'https://iiif.harv...                            NaN
## 21                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 22                           None                    1  ...  [{'id': 'https://iiif.harv...                            NaN
## 23                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 24  © Artists Rights Society (...                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 25               © Richard Tuttle                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 26  © Estate of Alfred Stiegli...                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 27                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 28                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 29                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 30                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 31                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 32                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 33  © Estate of Alfred Stiegli...                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 34                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 35                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 36                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 37                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 38                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 39                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 40                           None                    0  ...  [{'id': 'https://iiif.harv...                            NaN
## 41                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 42                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 43  ©Vija Celmins, Courtesy Ma...                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 44                           None                    1  ...  [{'id': 'https://iiif.harv...                            NaN
## 45                           None                    1  ...  [{'id': 'https://iiif.harv...                            NaN
## 46  © Andreas Gursky / Artists...                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 47                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 48                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 49                           None                    0  ...  [{'id': 'https://iiif.harv...  [{'role': 'Artist', 'birth...
## 
