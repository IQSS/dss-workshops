...
\midrule
\endhead
1. character & ``a'', ``swc''\tabularnewline
2. numeric (decimal) & 2, 15.5\tabularnewline
3. integer & 2L (the L tells R to store this as an
integer)\tabularnewline
4. logical & TRUE, FALSE\tabularnewline
5. complex & 1+4i (complex numbers with real and imaginary
parts)\tabularnewline
\bottomrule
\end{longtable}

There are two fundamental data structures in R: 1) vectors, and 2)
lists.

\textbf{Homogeneous data structures:}
...
1. atomic vector\strut
\end{minipage} & \begin{minipage}[t]{0.80\columnwidth}\raggedright\strut
contains elements of the same \textbf{type}, which can be one of these
\textbf{modes}: character, numeric, integer, logical\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.14\columnwidth}\raggedright\strut
2. array\strut
\end{minipage} & \begin{minipage}[t]{0.80\columnwidth}\raggedright\strut
...
\textbf{Heterogeneous data structures:}
