...
to your fellow workshop attendees and instructors, please show up to
your workshop on time, having pre-installed all necessary software and
materials.}
...
\item
  ...
  command prompt (the greater-than sign: \texttt{\textgreater{}}) type
...
\item
  ...
  console at the command prompt (the greater-than sign:
  \texttt{\textgreater{}}) and press enter:
  ...
  If you do not see this message and encounter an error --- try
...
\item
  ...
  If successful, in the console you should see just a command prompt
  (\texttt{\textgreater{}}) with no messages to the right of it.
...
\item
  We do assume you know \emph{why} you want to learn R. If you don't,
...
While graphical-based statistical software (e.g., SPSS) immediately
display the results of an analysis, R stores results in an
\texttt{object} (a data structure), so that an analysis can be done with
no result displayed. Such a feature is very useful, since a user can
extract only that part of the results that is of interest and can pass
results into further analyses.
...
It will be useful when you view the above materials to see different
file extensions on your computer:
