...
The following RStudio and \texttt{rmarkdown} cheatsheets will provide a
useful reference:
...
\tightlist
\item
  CRAN, 2) Bioconductor, 3) Github, and 4) R Forge.
\end{enumerate}
...
cheatsheets will also provide a useful reference:
\url{https://rstudio.com/wp-content/uploads/2019/01/Cheatsheets_2019.pdf}
