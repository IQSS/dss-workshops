...
\item
  \href{./Rmodels.html}{Regression models in R}
\item
  \href{./Rgraphics.html}{Graphics in R using ggplot2}
\item
  \href{./RDataWrangling.html}{R data wrangling}
\item
  \href{./PythonIntro.html}{Introduction to Python}
\item
  \href{./PythonWebScrape.html}{Python web-scraping}
\item
  \href{./StataIntro.html}{Introduction to Stata}
\end{enumerate}
...
\textbf{Topics} - Assignment - Function arguments - Finding help -
...
\subsection{Workshop goals and
approach}\label{workshop-goals-and-approach}
...
\subsection{Help us make this workshop
...
\textbf{Topics} - R formula interface - Factor contrasts to test
specific hypotheses - Model comparisons - Run and interpret variety of
regression models in R

\section{Setup instructions}\label{setup-instructions-1}
...
\NormalTok{  states.data <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"R/Rmodels/dataSets/states.rds"}\NormalTok{) }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{  NH11 <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"R/Rmodels/dataSets/NatHealth2011.rds"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{  Exam <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"R/Rmodels/dataSets/Exam.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{  states <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"R/Rmodels/dataSets/states.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsection{Help us make this workshop
better!}\label{help-us-make-this-workshop-better-1}
...
\item
  \url{http://tinyurl.com/RstatisticsFeedback}
\end{itemize}
...
\item
  ...
  \tightlist
  \item
    Website: \url{http://gking.harvard.edu/zelig}
  \item
    Documentation: \url{http://r.iq.harvard.edu/docs/zelig.pdf}
  \end{itemize}
\item
  Ameila
  ...
  \tightlist
  \item
    Website: \url{http://gking.harvard.edu/Amelia/}
  \item
    Documetation: \url{http://r.iq.harvard.edu/docs/amelia/amelia.pdf}
  \end{itemize}
\end{itemize}

\chapter{R Graphics}\label{r-graphics}

\textbf{Topics} - R ggplot2 package - Setup basic plots - Add and modify
scales and legends - Manipulate plot labels

\section{Setup instructions}\label{setup-instructions-2}
...
\subsection{Workshop Overview}\label{workshop-overview}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{housing <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\StringTok{"R/Rgraphics/dataSets/landdata-states.csv"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\StringTok{"R/Rgraphics/dataSets/EconomistData.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsection{Add title and format axes}\label{add-title-and-format-axes}
...
\subsection{Help Us Make This Workshop
Better!}\label{help-us-make-this-workshop-better-2}
...
\item
  These workshops exist for you -- tell us what you need!
\item
  \url{http://tinyurl.com/R-graphics-feedback}
\end{itemize}
...
\item
  ...
  \tightlist
  \item
    Research technology consulting: \url{http://dss.iq.harvard.edu}
  \item
    Workshops materials:
    \url{http://dss.iq.harvard.edu/workshop-materials}
  \item
    Workshop schedule and registration:
    \url{http://dss.iq.harvard.edu/workshop-registration}
  \end{itemize}
\end{itemize}
...
\section{Setup instructions}\label{setup-instructions-3}
...
\section{Example project overview}\label{example-project-overview}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boy.file.names <-}\StringTok{ }\KeywordTok{list.files}\NormalTok{(}\StringTok{"R/RDataWrangling/dataSets/boys"}\NormalTok{, }\DataTypeTok{full.names =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section{Additional reading and
resources}\label{additional-reading-and-resources}
...
\tightlist
\item
  Institute for Quantitative Social Science: \url{http://iq.harvard.edu}
\item
  IQSS Data Science Services: \url{http://dss.iq.harvard.edu/}
\end{itemize}
...
\section{Setup instructions}\label{setup-instructions-4}
...
\section{Setup instructions}\label{setup-instructions-5}
...
\section{Workshop goals and
approach}\label{workshop-goals-and-approach-2}
...
\section{Example project overview and
goals}\label{example-project-overview-and-goals}
...
\chapter{Introduction to Stata}\label{introduction-to-stata}
...
\section{Setup instructions}\label{setup-instructions-6}
...
\subsection{Workshop description}\label{workshop-description-1}
...
\subsection{Why stata?}\label{why-stata}
...
\subsection{Help us make this workshop
better!}\label{help-us-make-this-workshop-better-3}
...
\item
  ...
  \item
    ...
    MIT users
  \item
    \url{http://www.iq.harvard.edu/research_computing}
  \item
