...
\begin{Highlighting}[]
  ...
  \CommentTok{# setwd("C:/Users/dataclass/Desktop/Rintro") # MS Windows}
\end{Highlighting}
\end{Shaded}
...
\subsection{Ex 0: solution}\label{ex-0-solution}
...
\subsection{Ex 1: solution}\label{ex-1-solution}
...
\subsection{Ex 2: solution}\label{ex-2-solution}
...
\subsection{Ex 3: solution}\label{ex-3-solution}
