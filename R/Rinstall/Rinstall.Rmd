...
**Your professional conduct is greatly appreciated. Out of respect to your fellow workshop attendees and instructors, please show up to your workshop on time, having pre-installed all necessary software and materials.**
...
2.  **Install `tidyverse`**
    ...
    In the left-hand side window (called the `console`), at the command prompt (the greater-than sign: `>`) type the following and press enter:
...
3.  **Check that installation was successful**
    ...
    Type the following in the console at the command prompt (the greater-than sign: `>`) and press enter:
...
2.  **Check that installation was successful**
    ...
    If successful, in the console you should see just a command prompt (`>`) with no messages to the right of it.
