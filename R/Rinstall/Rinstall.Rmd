...
For these workshops we will use [RStudio](https://rstudio.com/); it is a good
...
We will use `tidyverse` packages throughout these R workshops, 
...
![](R/Rinstall/images/tidy_workflow.png)
