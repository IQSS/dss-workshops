...
* Install R by downloading and running [this .exe file](https://cran.r-project.org/bin/windows/base/release.htm) from [CRAN](http://cran.r-project.org/index.html). I
...
* R Models: <https://github.com/IQSS/dss-workshops/raw/master/R/Rmodels.zip>
...
* Choose `Existing Directory` and browse to the workshop materials directory.
