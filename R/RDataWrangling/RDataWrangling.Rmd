...
* [Download workshop materials](http://tutorials.iq.harvard.edu/R/RDataWrangling.zip)
...
```{r}
  ...
  # setwd("~/Desktop/RDataWrangling") # UNIX-based
  # setwd("C:/Users/dataclass/Desktop/RDataWrangling") # MS Windows
```
