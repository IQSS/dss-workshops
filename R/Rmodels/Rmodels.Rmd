...
```{r}
  ...
  states.data <- readRDS("R/Rmodels/dataSets/states.rds") 
  #get labels
...
```{r}
  NH11 <- readRDS("R/Rmodels/dataSets/NatHealth2011.rds")
...
```{r}
  Exam <- readRDS("R/Rmodels/dataSets/Exam.rds")
```
...
```{r}
  states <- readRDS("R/Rmodels/dataSets/states.rds")
```
