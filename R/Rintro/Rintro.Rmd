...
```{r}
  ...
  # setwd("C:/Users/dataclass/Desktop/Rintro") # MS Windows
```
...
## Ex 1: Reading the baby names data
...
## Ex 2: Peak popularity of your name
...
## Ex 3: Plotting peak popularity of your name
...
## Ex 5: Popularity of most popular names
...
Please take 60 seconds to fill out a very short feedback [form](http://bit.ly/training_class_eval)
