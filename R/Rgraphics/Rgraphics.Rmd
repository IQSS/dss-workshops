...
* [Download workshop materials](http://tutorials.iq.harvard.edu/R/Rgraphics.zip)
...
```{r}
  ...
  # setwd("~/Desktop/Rgraphics") # UNIX-based
  # setwd("C:/Users/dataclass/Desktop/Rgraphics") # MS Windows
```
...
Each `geom_` has a particular set of aesthetic mappings associated with it, some of which are required and some optional:


| `geom_`          | Usage           | Possible Aesthetics                                              |
|:-----------------|:----------------|:-----------------------------------------------------------------|
...
| `geom_smooth()`  | Smoothed means  |`x`,`y`,`alpha`,`color`,`fill`,`group`,`linetype`,`size`,`weight` |
| `geom_jitter()`  | Jittered points |`x`,`y`,`alpha`,`color`,`fill`,`group`,`shape`,`size`,`stroke`    |
