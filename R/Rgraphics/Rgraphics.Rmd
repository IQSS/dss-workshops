...
Here is a list of `geom`s and their default statistics <https://ggplot2.tidyverse.org/reference/>
...
```{r}
base_plot <- ggplot(housing, aes(x = State, y = Home.Price.Index)) + 
...
```{r}
pc2 <- pc1 +
  geom_smooth(mapping = aes(linetype = "solid"),
              method = "lm",
