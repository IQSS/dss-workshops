...
*
* A handy set of [Stata cheat-sheets](stata-cheat-sheets.pdf) is available to help you look up and remember command syntax. 
*
...
* * We do assume you know **why** you want to learn Stata. If you don't, and want a comparison of Stata to other statistical software, see our [Data Science Tools](https://iqss.github.io/dss-workshops/general/tools.html) workshop
