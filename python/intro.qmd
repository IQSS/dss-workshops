...
#| include: false
import os
os.chdir("intro")  # the materials directory: code paths as learners see them
```
...
A handy [cheat-sheet](intro/python-cheat-sheet-basic.pdf) is available to help you look up and remember basic syntax.
...
* We do assume you know **why** you want to learn Python. If you don't, and want a comparison of Python to other statistical software, see our [Data Science Tools](../general/tools.qmd) workshop
...
1. Start Positron.
2. Go to `File -> Open Folder` and choose the `python-intro` folder from the workshop materials on your desktop. If Positron asks which Python to use, choose the one in `.venv` (the [installation page](install.qmd) explains `uv sync`, which creates it).
...
![](images/intro/notebook_file_completion.png).
...
![](images/intro/notebook_string_completion.png) 
...
<center>
![](images/intro/for_loop_pic_small.png)
</center>
...
<center>
![](images/intro/python_for_loop_small.png)
</center>
