...
1. Start Positron.
2. Go to `File -> Open Folder` and choose the `intro` folder from the workshop materials on your desktop. If Positron asks which Python to use, choose the one in `.venv` (the [installation page](install.qmd) explains `uv sync`, which creates it).
