...
#
# Follow the [Python Installation](https://iqss.github.io/dss-workshops/python/install.html) instructions and ensure that you can successfully start Positron.
#
# A handy [cheat-sheet](python-cheat-sheet-basic.pdf) is available to help you look up and remember basic syntax.
#
# ### Class Structure
#
...
# * We do assume you know **why** you want to learn Python. If you don't, and want a comparison of Python to other statistical software, see our [Data Science Tools](https://iqss.github.io/dss-workshops/general/tools.html) workshop
...
#
# 1. Start Positron.
# 2. Go to `File -> Open Folder` and choose the `python-intro` folder from the workshop materials on your desktop. If Positron asks which Python to use, choose the one in `.venv` (the [installation page](https://iqss.github.io/dss-workshops/python/install.html) explains `uv sync`, which creates it).
# 3. In the Explorer on the left, click the file with the word "BLANK" in the name (`intro_BLANK.ipynb`). It opens in Positron's notebook editor, with the kernel picker at the top right showing the Python from `.venv`.
#
...
#
# ![](images/notebook_file_completion.png).
#
...
#
# ![](images/notebook_string_completion.png) 
#
...
#
# <center>
# ![](images/python_for_loop_small.png)
# </center>
#
# Notice that:
#
