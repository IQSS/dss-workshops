...
#| include: false
import os
os.chdir("webscrape")  # the materials directory: code paths as learners see them
```

::: {.callout-warning title="These examples need revising"}
...
Follow the [Python Installation](install.qmd) instructions and ensure that you can successfully start Positron.
...
If you need an introduction to Python or a refresher, we recommend our [Python Introduction](intro.qmd).
...
![](images/webscrape/client_server.png)
...
![](images/webscrape/json-format.png)
...
![](images/webscrape/dev_tools.png)

![](images/webscrape/dev_tools_pane.png)
...
![](images/webscrape/dev_tools_network.png)
...
1. Start Positron.
2. Go to `File -> Open Folder` and choose the `python-webscrape` folder from the workshop materials on your desktop. If Positron asks which Python to use, choose the one in `.venv` (the [installation page](install.qmd) explains `uv sync`, which creates it).
...
![](images/webscrape/dev_tools_right_click.png)

![](images/webscrape/dev_tools_inspect.png)
...
![](images/webscrape/dev_tools_xpath.png)
...
![](images/webscrape/dev_tools_figcaption.png)
