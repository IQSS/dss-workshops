...
You should have already installed the `tidyverse` and `rmarkdown` packages onto your computer before the workshop --- see [R Installation](install.qmd). Now let's load these packages into the search path of our R session.
