...
# **Example data**
#
# The UK [Office for National Statistics](https://www.ons.gov.uk) publishes the most popular boys' names in England and Wales every year, separately for boys and girls, in Excel spreadsheets. We will work with the twenty files covering **1996 to 2015**, exactly as they came from the ONS website.
#
# **Overall Goal** 
#
# Our mission is to extract and graph the **top 100** boys names in England and Wales for every year from **1996 to 2015**. 
#
# <center>
...
#
# **Steps to accomplish the goal of extracting and graphing the *top 100* boys names in England and Wales for every year from 1996 to 2015:**
#
...
#
# The ONS still publishes these figures every year, but the format has moved
# on: from 2022 the worksheet is named `Table_1` rather than `Table 1`, and by
# the 2025 edition the table has been flattened into a single list of ranks 1
# to 100 instead of two blocks side by side. We keep the 1996--2015 files
# because that heterogeneity is the thing being taught here --- and the change
# is itself the lesson, since code written against one year's layout will not
# survive the publisher tidying up.
#
