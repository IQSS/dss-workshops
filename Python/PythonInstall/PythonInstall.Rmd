...
Before starting any of our Python workshops, it is necessary to install the Anaconda Python 3 distribution. It is essential that you have Anaconda **pre-installed** so that we can start the workshop on time. Depending on your internet speed, the installation may take a long time. If you are unable to install Anaconda, please stop by the training room at least 20 minutes prior to the start of the workshop. The Anaconda Python distribution is designed with data Science in mind and contains a curated set of 270+ pre-installed packages.
