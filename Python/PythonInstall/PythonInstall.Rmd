...
There are two ways to set up your working environment for using Jupyter Notebooks:

1. using **JupyterLab**
2. using **Jupyter Notebook** directly

[JupyterLab](https://jupyterlab.readthedocs.io/en/stable/) is a web-based interface for Jupyter Notebooks that combines many features typically found on integrated development environments (IDEs). [Jupyter Notebooks](https://jupyter-notebook.readthedocs.io/en/stable/) are documents that combine text, code, images, math, and rich media and can be viewed in a browser. Opening a notebook directly does not give you access to features typically found on IDEs.
