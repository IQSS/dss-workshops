...
# **Document Object Model (DOM)**. DOM is a cross-platform and language-independent 
...
# a logical tree. *Each branch of the tree ends in a node, and each node contains objects*. 
